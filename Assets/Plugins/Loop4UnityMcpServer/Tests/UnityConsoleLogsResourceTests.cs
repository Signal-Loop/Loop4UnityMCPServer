...
namespace LoopMcpServer.Tests
{
    ...
    public class UnityConsoleLogsResourceTests
    {
        ...
        public void Read_AlwaysReturnsResourcesReadResult()
        {
            ...
            Assert.IsInstanceOf<LoopMcpServer.Protocol.ResourcesReadResult>(result);
        }
        ...
        {
            Assert.IsInstanceOf<LoopMcpServer.Interfaces.IResource>(resource);
        }
